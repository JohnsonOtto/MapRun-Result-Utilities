...
def xml2excel(filelist):
    global root
    writer = pd.ExcelWriter("C:/Users/Johannes/coding/maprun-xml2xslx/wsdaw.xlsx", engine="xlsxwriter")
...
class window(QMainWindow):
    ...
    def initUI(self):
        ...
        self.button1.setText("Dateien auswählen")
        self.button1.setFont(QFont("Arial", 11))
        self.button1.clicked.connect(self.button1Clicked)

        self.button2 = QPushButton(self)
        self.button2.setGeometry(10,95,250,75)
        self.button2.setText("Speicherort wählen")
        self.button2.setFont(QFont("Arial", 11))
        self.button2.clicked.connect(self.button2Clicked)

        self.button4 = QPushButton(self)
        self.button4.setGeometry(10,180,250,75)
        self.button4.setText("Schließen")
        self.button4.setFont(QFont("Arial", 11))
    ...
    def saveFileNameDialog(self):
        filename, _ = QFileDialog.getSaveFileName(self,"Save as", "","Excel (*.xlsx)")
        if filename:
            return filename
    ...
    def button2Clicked(self):
        saveFile = self.saveFileNameDialog()
        print(saveFile)
